...
- answer generation via `gemini-3.1-flash-lite`
...
| Generation model | Gemini API `gemini-3.1-flash-lite` | stable low-latency model used first; move up only if eval quality requires it |
